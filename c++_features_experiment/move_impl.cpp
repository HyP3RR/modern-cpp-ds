...
template <typename T>
constexpr T &&my_forward(typename remove_reference<T>::type &t) noexcept {
    return static_cast<T &&>(t);
}
// T& -> returns T& and t is T& as well
// T&& -> returns T&& and t is T& as well due to remove_reference
